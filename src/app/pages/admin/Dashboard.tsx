          ...
          <div className="backdrop-blur-xl bg-white/90 border border-purple-200/30 rounded-3xl p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold text-slate-900">Yatak & Yastık Rehberi</div>
                  <div className="text-xs text-slate-600">Rehber yazıları (toplu yükleme)</div>
                </div>
              </Link>
