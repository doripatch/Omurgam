...
// Health check
app.get("/make-server-b69488c3/health", (c) => {
...
app.get("/make-server-b69488c3/seed", async (c) => {
  try {
...
app.get("/make-server-b69488c3/seed-direct", async (c) => {
  try {
...
app.get("/make-server-b69488c3/seed-test", async (c) => {
...
app.get("/make-server-b69488c3/create-ceyhan", async (c) => {
  try {
...
app.post("/make-server-b69488c3/reset-admins", async (c) => {
  try {
...
app.post("/make-server-b69488c3/signin", async (c) => {
  try {
...
// Sign up endpoint
app.post("/make-server-b69488c3/signup", async (c) => {
  try {
...
app.get("/make-server-b69488c3/session", async (c) => {
  try {
...
// Get site settings
app.get("/make-server-b69488c3/site-settings", async (c) => {
  try {
...
app.put("/make-server-b69488c3/site-settings", async (c) => {
  try {
...
// Get all videos
app.get("/make-server-b69488c3/videos", async (c) => {
  try {
...
// Get video by ID
app.get("/make-server-b69488c3/videos/:id", async (c) => {
  try {
...
// Create video
app.post("/make-server-b69488c3/videos", async (c) => {
  try {
...
// Update video
app.put("/make-server-b69488c3/videos/:id", async (c) => {
  try {
    const id = c.req.param("id");
    const body = await c.req.json();
...
// Delete video
app.delete("/make-server-b69488c3/videos/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
app.post("/make-server-b69488c3/videos/:id/view", async (c) => {
  try {
    const id = c.req.param("id");
    const video = await kv.get(`video_${id}`);
...
// Get video comments
app.get("/make-server-b69488c3/videos/:id/comments", async (c) => {
  try {
...
// Add video comment
app.post("/make-server-b69488c3/videos/:id/comments", async (c) => {
  try {
    const videoId = c.req.param("id");
    const userToken = c.req.header("X-User-Token");
...
app.delete("/make-server-b69488c3/videos/:videoId/comments/:commentId", async (c) => {
  try {
...
// Like/Unlike video
app.post("/make-server-b69488c3/videos/:id/like", async (c) => {
  try {
    const videoId = c.req.param("id");
    const userToken = c.req.header("X-User-Token");
...
app.get("/make-server-b69488c3/videos/:id/like-status", async (c) => {
  try {
    const videoId = c.req.param("id");
    const userToken = c.req.header("X-User-Token");
...
// Get all questions
app.get("/make-server-b69488c3/questions", async (c) => {
  try {
...
// Get question by ID
app.get("/make-server-b69488c3/questions/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
// Create question
app.post("/make-server-b69488c3/questions", async (c) => {
  try {
    const body = await c.req.json();
    const id = crypto.randomUUID();
    const question = {
...
// Update question
app.put("/make-server-b69488c3/questions/:id", async (c) => {
  try {
    const id = c.req.param("id");
    const body = await c.req.json();
...
// Delete question
app.delete("/make-server-b69488c3/questions/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
// Approve question
app.post("/make-server-b69488c3/questions/:id/approve", async (c) => {
  try {
    const id = c.req.param("id");
    const question = await kv.get(`question_${id}`);
...
// Answer question
app.post("/make-server-b69488c3/questions/:id/answer", async (c) => {
  try {
    const id = c.req.param("id");
...
// Get all blog posts
app.get("/make-server-b69488c3/blog", async (c) => {
  try {
...
// Get blog post by ID
app.get("/make-server-b69488c3/blog/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
// Create blog post
app.post("/make-server-b69488c3/blog", async (c) => {
  try {
    const body = await c.req.json();
    const id = crypto.randomUUID();
    const post = {
...
// Update blog post
app.put("/make-server-b69488c3/blog/:id", async (c) => {
  try {
    const id = c.req.param("id");
    const body = await c.req.json();
...
app.post("/make-server-b69488c3/blog/:id/view", async (c) => {
  try {
    const id = c.req.param("id");
    const post = await kv.get(`blog_${id}`);
...
// Get all terms
app.get("/make-server-b69488c3/terms", async (c) => {
  try {
...
// Get term by ID
app.get("/make-server-b69488c3/terms/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
// Create term
app.post("/make-server-b69488c3/terms", async (c) => {
  try {
    const body = await c.req.json();
    const id = crypto.randomUUID();
    const term = {
...
// Update term
app.put("/make-server-b69488c3/terms/:id", async (c) => {
  try {
    const id = c.req.param("id");
    const body = await c.req.json();
...
// Delete term
app.delete("/make-server-b69488c3/terms/:id", async (c) => {
  try {
    const id = c.req.param("id");
...
// Search terms
app.get("/make-server-b69488c3/terms/search", async (c) => {
  try {
...
app.get("/make-server-b69488c3/admin/users", async (c) => {
  try {
...
app.put("/make-server-b69488c3/admin/users/role", async (c) => {
  try {
...
app.delete("/make-server-b69488c3/admin/users/:userId", async (c) => {
  try {
